...
public final class Autos
{
  ...
  public static CommandBase driveAndSpin(SwerveSubsystem swerve)
  {
    return Commands.sequence(
        new RepeatCommand(new InstantCommand(() -> swerve.drive(new Translation2d(1, 0), 0, true), swerve)));
  }
...
// position, heading(direction of travel), holonomic rotation
    ...
    {
      List<PathPlannerTrajectory> example1 = PathPlanner.loadPathGroup("NateSamplePath", new PathConstraints(4, 3));
